...
public partial class Board : Node2D
{
	...
	[Export] CanvasModulate illumination;
	...
	private int illuminationCount = 0;
	private int Filas;
	...
	public override void _Ready()
	{
		...
		PlacePlayers();
		Place(TrapCount, GlobalData.Traps, "res://scenes/hazards/trap.tscn");
		Place(FireCount, GlobalData.Fire, "res://scenes/hazards/fire.tscn");
		Place(TeleportCount, GlobalData.Teleport, "res://scenes/hazards/teleport.tscn");
		Place(MistCount, GlobalData.Mist, "res://scenes/hazards/mist.tscn");
		Place(GemCount, GlobalData.Gem, "res://scenes/items/gem.tscn");
		Place(HeartCount, GlobalData.Heart, "res://scenes/items/heart.tscn");
		Place(WolfCount, GlobalData.Wolf, "res://scenes/enemies/wolf.tscn");
		Place(SpectreCount, GlobalData.Spectre, "res://scenes/enemies/spectre.tscn");
		Place(SkeletonCount, GlobalData.Skeleton, "res://scenes/enemies/skeleton.tscn");
	}
	public override void _Process(double delta)
	{
		if (Input.IsActionJustPressed("decrease_illumination")) DecreaseIllumination();
		if (Input.IsActionJustPressed("increase_illumination")) IncreaseIllumination();
	}
	public void DecreaseIllumination()
	{
		if (illuminationCount > -3)
		{
			modulateColor = illumination.Color;
			illumination.Color = new Color(modulateColor.R - 0.05f, modulateColor.G - 0.05f, modulateColor.B - 0.05f, modulateColor.A);
			illuminationCount--;
		}
	}
	public void IncreaseIllumination()
	{
		if (illuminationCount < 3)
		{
			modulateColor = illumination.Color;
