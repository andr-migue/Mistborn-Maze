...
public partial class CharacterSelect : Control { 
    ...
    public override void _Ready() {
        ...
        showCharacters[0] = GD.Load<PackedScene>("res://scenes/characters/previews/cid.tscn");
        showCharacters[1] = GD.Load<PackedScene>("res://scenes/characters/previews/cleome.tscn");
        showCharacters[2] = GD.Load<PackedScene>("res://scenes/characters/previews/lasswell.tscn");
        showCharacters[3] = GD.Load<PackedScene>("res://scenes/characters/previews/jake.tscn");
        showCharacters[4] = GD.Load<PackedScene>("res://scenes/characters/previews/rain.tscn");
        showCharacters[5] = GD.Load<PackedScene>("res://scenes/characters/previews/nichols.tscn");
        // Cargar personajes jugables
        playableCharacters[0] = GD.Load<PackedScene>("res://scenes/characters/cid.tscn");
        playableCharacters[1] = GD.Load<PackedScene>("res://scenes/characters/cleome.tscn");
        playableCharacters[2] = GD.Load<PackedScene>("res://scenes/characters/lasswell.tscn");
        playableCharacters[3] = GD.Load<PackedScene>("res://scenes/characters/jake.tscn");
        playableCharacters[4] = GD.Load<PackedScene>("res://scenes/characters/rain.tscn");
        playableCharacters[5] = GD.Load<PackedScene>("res://scenes/characters/nichols.tscn");
